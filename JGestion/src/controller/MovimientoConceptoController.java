...
public class MovimientoConceptoController implements Serializable {
    ...
    private MovimientoConcepto EL_OBJECT;
    ...
    public List<MovimientoConcepto> findAll() {
    ...
    public void initABM(JFrame jFrame) throws MessageException {
        ...
        abm.getbAceptar().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (EL_OBJECT == null) {
                    EL_OBJECT = new MovimientoConcepto();
                }
        ...
        abm.getbEliminar().addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if (JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(abm, "¿Eliminar movimiento concepto \"" + EL_OBJECT + "\"?", null, JOptionPane.YES_NO_OPTION)) {
                    try {
        ...
        abm.getjTable1().addMouseListener(new MouseAdapter() {
            ...
            public void mouseReleased(MouseEvent e) {
                ...
                if (selectedRow > -1) {
                    EL_OBJECT = (MovimientoConcepto) DAO.getEntityManager().find(MovimientoConcepto.class,
