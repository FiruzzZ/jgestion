...
public class NotaDebitoController {
    ...
    void initNotaDebitoUI(Window owner, boolean modal, boolean loadDefaultData) {
        abm = new JDNotaDebito(owner, modal);
    ...
    private NotaDebito getEntity() throws MessageException {
        ...
        DefaultTableModel dtm = (DefaultTableModel) abm.getjTable1().getModel();
        List<DetalleNotaDebito> detalle = new ArrayList<DetalleNotaDebito>(dtm.getRowCount());
    ...
    private void checkConstraints() throws MessageException {
        ...
        if (unlockedNumeracion) {
            try {
                ...
                if (old != null) {
                    throw new MessageException("Ya existe un registro del comprobante N° " + JGestionUtils.getNumeracion(old, true));
                }
    ...
    private void cargarTablaBuscador(String query) {
        ...
        for (NotaDebito notaDebito : l) {
            dtm.addRow(new Object[]{
                        ...
                        JGestionUtils.getNumeracion(notaDebito, true),
...
//        buscador.setListeners(this);
    ...
    private String armarQuery() throws MessageException {
        ...
        if (buscador.getCbClieProv().getSelectedIndex() > 0) {
            query.append(" AND o.cliente_id = ").append(((Cliente) buscador.getCbClieProv().getSelectedItem()).getId());
        }
