...
//         DefaultTableModel dtm = (DefaultTableModel) ((javax.swing.JTable) e.getSource()).getModel();
    ...
    private void setPanelABM(Usuario u) {
        ...
        panel.getCheckConfiguracion().setSelected(p.isConfiguracion());
    ...
    private Permisos getPermisos(Permisos permisos) {
        ...
        permisos.setConfiguracion(panel.getCheckConfiguracion().isSelected());
        return permisos;
    }
    ...
    public static void checkPermiso(PermisoDe permisoToCheck) throws MessageException {
        ...
        } else if (PermisoDe.CONFIGURACION.equals(permisoToCheck)) {
            permitido = CURRENT_USER.getPermisos().isConfiguracion();
        }
        if (!permitido) {
