...
import utilities.general.ClipboardHandler;
...
public class PanelABMProductos extends javax.swing.JPanel {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(jPanel2Layout.createSequentialGroup()
                            .addComponent(tfPrecio, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(jLabel17)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(tfCostoCompra, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(164, 164, 164))
                        .addComponent(checkUpdatePrecioVenta, javax.swing.GroupLayout.Alignment.LEADING)))
    ...
    private void jLabelFotoMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelFotoMouseReleased
        if (evt.isPopupTrigger()) {
            try {
                Image image = ClipboardHandler.getImage();
                if (image != null) {
                    jLabelFoto.setText(null);
                    BufferedImage bi = UTIL.Image.toBufferedImage(image);
                    UTIL.setImageAsIconLabel(jLabelFoto, bi);
                }
            } catch (Exception ex) {
                Logger.getLogger(PanelABMProductos.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }//GEN-LAST:event_jLabelFotoMouseReleased
    ...
    private javax.swing.JButton btnAddRubros;
